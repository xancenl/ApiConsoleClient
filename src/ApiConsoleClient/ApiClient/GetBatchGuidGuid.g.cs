...
{
    internal async Task<MontaRESTApiModels_Batches_Batch> GetBatchGuidGuidAsync(GetBatchGuidGuidRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/Batch/guid/{guid}";
            ...
            return await ReadJsonAsync<MontaRESTApiModels_Batches_Batch>(resp).ConfigureAwait(false);
        }
