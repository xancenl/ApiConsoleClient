...
{
    internal async Task<MontaRESTApiModels_InboundForecast_InboundForecast> GetInboundforecastGroupReferenceSkuAsync(GetInboundforecastGroupReferenceSkuRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
