...
{
    internal async Task<System.Collections.Generic.List<MontaRESTApiModels_Orders_Order>> GetOrderAsync(GetOrderRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/order";
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaRESTApiModels_Orders_Order>>(resp).ConfigureAwait(false);
        }
