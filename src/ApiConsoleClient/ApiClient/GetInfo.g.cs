...
{
    internal async Task<MontaRESTApiModels_Info_Info> GetInfoAsync(GetInfoRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/info";
            ...
            if (req.Origin is not null) q["origin"] = Convert.ToString(req.Origin, System.Globalization.CultureInfo.InvariantCulture);
            ...
            return await ReadJsonAsync<MontaRESTApiModels_Info_Info>(resp).ConfigureAwait(false);
        }
