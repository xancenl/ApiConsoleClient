...
{
    internal async Task<MontaRESTApiModels_Product_Product> GetProductSkuAsync(GetProductSkuRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
