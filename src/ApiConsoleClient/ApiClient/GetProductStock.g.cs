...
{
    internal async Task<MontaRESTApiModels_Product_Product> GetProductStockAsync(GetProductStockRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/product/stock";
