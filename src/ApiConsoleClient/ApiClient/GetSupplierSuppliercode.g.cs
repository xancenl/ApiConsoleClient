...
{
    internal async Task<MontaRESTApiModels_Supplier_Supplier> GetSupplierSuppliercodeAsync(GetSupplierSuppliercodeRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
