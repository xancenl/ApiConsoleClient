...
{
    internal async Task<MontaRestApiModels_Orders_ShippedOrder_ShippedOrder> GetOrderWebshoporderidColliAsync(GetOrderWebshoporderidColliRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            return await ReadJsonAsync<MontaRestApiModels_Orders_ShippedOrder_ShippedOrder>(resp).ConfigureAwait(false);
        }
