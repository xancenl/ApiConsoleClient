...
{
    internal async Task<MontaModel_WMS_Materialen_ProductGroups_Models_ProductGroup> PostProductGroupAsync(PostProductGroupRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
