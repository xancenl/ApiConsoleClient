...
{
    internal async Task<System.Collections.Generic.List<MontaRESTApiModels_Orders_PurchaseOrderGroup>> GetPurchaseOrderGroupAsync(GetPurchaseOrderGroupRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/PurchaseOrderGroup";
            ...
            if (req.CreationDate is not null) q["creationDate"] = ((System.DateTimeOffset)req.CreationDate).ToString("yyyy-MM-ddTHH:mm:ssK", System.Globalization.CultureInfo.InvariantCulture);
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaRESTApiModels_Orders_PurchaseOrderGroup>>(resp).ConfigureAwait(false);
        }
