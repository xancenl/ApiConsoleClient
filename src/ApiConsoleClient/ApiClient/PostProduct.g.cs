...
{
    internal async Task<MontaRESTApiModels_Product_Product> PostProductAsync(PostProductRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/product";
