...
{
    internal async Task<System.Collections.Generic.List<MontaRESTApiModels_Orders_OrderLine>> GetOrderWebshoporderidLinesdeletedAsync(GetOrderWebshoporderidLinesdeletedRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/order/{webshoporderid}/linesdeleted";
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaRESTApiModels_Orders_OrderLine>>(resp).ConfigureAwait(false);
        }
