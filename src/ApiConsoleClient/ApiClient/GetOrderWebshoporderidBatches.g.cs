...
{
    internal async Task<MontaRESTApi_Classes_Batches_BatchResult> GetOrderWebshoporderidBatchesAsync(GetOrderWebshoporderidBatchesRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/order/{webshoporderid}/batches";
            ...
            return await ReadJsonAsync<MontaRESTApi_Classes_Batches_BatchResult>(resp).ConfigureAwait(false);
        }
