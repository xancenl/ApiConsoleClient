...
{
    internal async Task<System.Collections.Generic.List<MontaModel_WMS_Materialen_ProductGroups_Models_ProductGroup>> GetProductGroupAsync(GetProductGroupRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/ProductGroup";
            ...
            if (req.RelatieSystemConnectionId is not null) q["relatieSystemConnectionId"] = Convert.ToString(req.RelatieSystemConnectionId, System.Globalization.CultureInfo.InvariantCulture);
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaModel_WMS_Materialen_ProductGroups_Models_ProductGroup>>(resp).ConfigureAwait(false);
        }
