...
{
    internal async Task<MontaRESTApiModels_ReturnForecast_ReturnForecast> PutReturnforecastCodeAsync(PutReturnforecastCodeRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
