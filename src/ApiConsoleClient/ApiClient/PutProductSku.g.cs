...
{
    internal async Task<MontaRESTApiModels_Product_Product> PutProductSkuAsync(PutProductSkuRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
