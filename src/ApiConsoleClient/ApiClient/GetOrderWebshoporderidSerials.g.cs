...
{
    internal async Task<object> GetOrderWebshoporderidSerialsAsync(GetOrderWebshoporderidSerialsRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/order/{webshoporderid}/serials";
