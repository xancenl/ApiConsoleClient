...
{
    internal async Task<MontaRESTApiModels_Supplier_Supplier> PostSupplierAsync(PostSupplierRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/supplier";
            ...
            return await ReadJsonAsync<MontaRESTApiModels_Supplier_Supplier>(resp).ConfigureAwait(false);
        }
