...
{
    internal async Task<System.Collections.Generic.List<MontaRESTApiModels_ReturnForecast_ReturnReason>> GetReturnreasonsAsync(GetReturnreasonsRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/returnreasons";
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaRESTApiModels_ReturnForecast_ReturnReason>>(resp).ConfigureAwait(false);
        }
