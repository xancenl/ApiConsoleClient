...
{
    internal async Task<string> GetInboundforecastGroupReferenceLabelAsync(GetInboundforecastGroupReferenceLabelRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/inboundforecast/group/{reference}/label";
