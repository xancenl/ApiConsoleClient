...
{
    internal async Task<MontaModel_WMS_Materialen_ProductGroups_Models_ProductGroup> GetProductGroupProductGroupIdAsync(GetProductGroupProductGroupIdRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/ProductGroup/{productGroupId}";
