...
{
    internal async Task DeleteProductSkuBarcodeAsync(DeleteProductSkuBarcodeRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/product/{sku}/barcode";
