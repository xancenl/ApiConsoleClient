...
{
    internal async Task DeleteProductSkuAsync(DeleteProductSkuRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/product/{sku}";
