...
{
    internal async Task<MontaRESTApiModels_Orders_Order> PutOrderWebshoporderidAsync(PutOrderWebshoporderidRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            return await ReadJsonAsync<MontaRESTApiModels_Orders_Order>(resp).ConfigureAwait(false);
        }
