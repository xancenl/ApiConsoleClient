...
{
    internal async Task<System.Collections.Generic.List<MontaRESTApiModels_InboundForecast_InboundForecastEvent>> GetInboundforecastEventsSinceidIdAsync(GetInboundforecastEventsSinceidIdRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/inboundforecast/events/since_id/{id}";
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaRESTApiModels_InboundForecast_InboundForecastEvent>>(resp).ConfigureAwait(false);
        }
