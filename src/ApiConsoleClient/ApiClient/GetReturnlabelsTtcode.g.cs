...
{
    internal async Task<MontaRestApiModels_ReturnLabel_ReturnLabel> GetReturnlabelsTtcodeAsync(GetReturnlabelsTtcodeRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/returnlabels/{ttcode}";
            ...
            return await ReadJsonAsync<MontaRestApiModels_ReturnLabel_ReturnLabel>(resp).ConfigureAwait(false);
        }
