...
{
    internal async Task<byte[]> GetReportsIdFileAsync(GetReportsIdFileRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/reports/{id}/file";
            ...
            return await resp.ResponseMessage.Content.ReadAsByteArrayAsync(System.Threading.CancellationToken.None).ConfigureAwait(false);
        }
