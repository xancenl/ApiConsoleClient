...
{
    internal async Task<MontaRESTApiModels_Return_Return> GetReturnIdAsync(GetReturnIdRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/return/{id}";
            ...
            return await ReadJsonAsync<MontaRESTApiModels_Return_Return>(resp).ConfigureAwait(false);
        }
