...
{
    internal async Task<System.Collections.Generic.List<MontaRestApiModels_Pickroutes_PickRouteDto>> GetPickroutesAsync(GetPickroutesRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/pickroutes";
            ...
            if (req.AssignedSince is not null) q["assigned_since"] = ((System.DateTimeOffset)req.AssignedSince).ToString("yyyy-MM-ddTHH:mm:ssK", System.Globalization.CultureInfo.InvariantCulture);
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaRestApiModels_Pickroutes_PickRouteDto>>(resp).ConfigureAwait(false);
        }
