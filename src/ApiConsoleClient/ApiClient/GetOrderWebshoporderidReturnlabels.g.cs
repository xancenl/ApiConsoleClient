...
{
    internal async Task<System.Collections.Generic.List<MontaRestApiModels_ReturnLabel_ReturnLabel>> GetOrderWebshoporderidReturnlabelsAsync(GetOrderWebshoporderidReturnlabelsRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/order/{webshoporderid}/returnlabels";
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaRestApiModels_ReturnLabel_ReturnLabel>>(resp).ConfigureAwait(false);
        }
