...
{
    internal async Task<System.Collections.Generic.List<MontaRESTApiModels_ReturnForecast_ReturnForecast>> GetOrderWebshoporderidReturnforecastsAsync(GetOrderWebshoporderidReturnforecastsRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/order/{webshoporderid}/returnforecasts";
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaRESTApiModels_ReturnForecast_ReturnForecast>>(resp).ConfigureAwait(false);
        }
