...
{
    internal async Task<MontaModel_WMS_Materialen_ProductGroups_Models_ProductGroup> PutProductGroupRemoveproductProductGroupIdAsync(PutProductGroupRemoveproductProductGroupIdRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/ProductGroup/removeproduct/{productGroupId}";
