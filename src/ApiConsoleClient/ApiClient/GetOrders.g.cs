...
{
    internal async Task<System.Collections.Generic.List<MontaModel_Efulfillment_Eorders_EorderHeader>> GetOrdersAsync(GetOrdersRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/orders";
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaModel_Efulfillment_Eorders_EorderHeader>>(resp).ConfigureAwait(false);
        }
