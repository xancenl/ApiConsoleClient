...
{
    internal async Task<MontaRESTApiModels_InboundForecast_InboundForecastGroup> PostInboundforecastGroupAsync(PostInboundforecastGroupRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
