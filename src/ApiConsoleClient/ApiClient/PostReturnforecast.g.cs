...
{
    internal async Task<MontaRESTApiModels_ReturnForecast_ReturnForecast> PostReturnforecastAsync(PostReturnforecastRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
