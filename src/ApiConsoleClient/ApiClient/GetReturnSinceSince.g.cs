...
{
    internal async Task<MontaRestApiModels_Dto_ReturnDto> GetReturnSinceSinceAsync(GetReturnSinceSinceRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/return/since/{since}";
