...
{
    internal async Task<MontaRESTApiModels_InboundForecast_InboundForecastGroup> GetInboundforecastGroupReferenceAsync(GetInboundforecastGroupReferenceRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
