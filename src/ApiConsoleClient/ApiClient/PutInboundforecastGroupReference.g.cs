...
{
    internal async Task<MontaRESTApiModels_InboundForecast_InboundForecastGroup> PutInboundforecastGroupReferenceAsync(PutInboundforecastGroupReferenceRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            return await ReadJsonAsync<MontaRESTApiModels_InboundForecast_InboundForecastGroup>(resp).ConfigureAwait(false);
        }
