...
{
    internal async Task<System.Collections.Generic.List<MontaRESTApiModels_Supplier_Supplier>> GetSupplierAsync(GetSupplierRequest req, System.Threading.CancellationToken cancellationToken = default)
    {
        try
        {
            var path = "/supplier";
            ...
            return await ReadJsonAsync<System.Collections.Generic.List<MontaRESTApiModels_Supplier_Supplier>>(resp).ConfigureAwait(false);
        }
