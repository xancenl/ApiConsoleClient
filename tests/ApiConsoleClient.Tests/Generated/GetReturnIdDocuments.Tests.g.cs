...
public sealed class GetReturnIdDocumentsTests
{
    [Fact]
    public async Task GetReturnIdDocuments_HappyPath()
    {
        ...
        var req = new GetReturnIdDocumentsRequest { Id = 1 };
        var result = await client.GetReturnIdDocumentsAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/return/1/documents").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetReturnIdDocuments_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetReturnIdDocumentsRequest { Id = 1 };
        var act = async () => await client.GetReturnIdDocumentsAsync(req, System.Threading.CancellationToken.None);
