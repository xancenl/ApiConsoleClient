...
public sealed class GetProductsTests
{
    ...
    public async Task GetProducts_HappyPath()
    {
        ...
        var req = new GetProductsRequest { Page = 1, IncludeSplitStock = true };
        var result = await client.GetProductsAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/products?page=1&includeSplitStock=true").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetProducts_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetProductsRequest { Page = 1, IncludeSplitStock = true };
        var act = async () => await client.GetProductsAsync(req, System.Threading.CancellationToken.None);
