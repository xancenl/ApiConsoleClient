...
public sealed class PostProductTests
{
    [Fact]
    public async Task PostProduct_HappyPath()
    {
        ...
        var req = new PostProductRequest { Body = default! };
        var result = await client.PostProductAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/product").WithVerb(System.Net.Http.HttpMethod.Post);
    }
    [Fact]
    public async Task PostProduct_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PostProductRequest { Body = default! };
        var act = async () => await client.PostProductAsync(req, System.Threading.CancellationToken.None);
