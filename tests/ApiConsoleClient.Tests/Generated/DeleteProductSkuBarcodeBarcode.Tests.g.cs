...
public sealed class DeleteProductSkuBarcodeBarcodeTests
{
    [Fact]
    public async Task DeleteProductSkuBarcodeBarcode_HappyPath()
    {
        ...
        var req = new DeleteProductSkuBarcodeBarcodeRequest { Sku = "x", Barcode = "x" };
        await client.DeleteProductSkuBarcodeBarcodeAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/product/x/barcode/x").WithVerb(System.Net.Http.HttpMethod.Delete);
    }
    [Fact]
    public async Task DeleteProductSkuBarcodeBarcode_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new DeleteProductSkuBarcodeBarcodeRequest { Sku = "x", Barcode = "x" };
        var act = async () => await client.DeleteProductSkuBarcodeBarcodeAsync(req, System.Threading.CancellationToken.None);
