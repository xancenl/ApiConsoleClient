...
public sealed class PostReturnforecastTests
{
    [Fact]
    public async Task PostReturnforecast_HappyPath()
    {
        ...
        var req = new PostReturnforecastRequest { Body = default! };
        var result = await client.PostReturnforecastAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/returnforecast").WithVerb(System.Net.Http.HttpMethod.Post);
    }
    [Fact]
    public async Task PostReturnforecast_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PostReturnforecastRequest { Body = default! };
        var act = async () => await client.PostReturnforecastAsync(req, System.Threading.CancellationToken.None);
