...
public sealed class PostSupplierTests
{
    [Fact]
    public async Task PostSupplier_HappyPath()
    {
        ...
        var req = new PostSupplierRequest { Body = default! };
        var result = await client.PostSupplierAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/supplier").WithVerb(System.Net.Http.HttpMethod.Post);
    }
    [Fact]
    public async Task PostSupplier_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PostSupplierRequest { Body = default! };
        var act = async () => await client.PostSupplierAsync(req, System.Threading.CancellationToken.None);
