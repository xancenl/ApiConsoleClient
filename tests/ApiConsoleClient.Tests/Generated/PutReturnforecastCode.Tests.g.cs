...
public sealed class PutReturnforecastCodeTests
{
    [Fact]
    public async Task PutReturnforecastCode_HappyPath()
    {
        ...
        var req = new PutReturnforecastCodeRequest { Code = "x", Body = default! };
        var result = await client.PutReturnforecastCodeAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/returnforecast/x").WithVerb(System.Net.Http.HttpMethod.Put);
    }
    [Fact]
    public async Task PutReturnforecastCode_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PutReturnforecastCodeRequest { Code = "x", Body = default! };
        var act = async () => await client.PutReturnforecastCodeAsync(req, System.Threading.CancellationToken.None);
