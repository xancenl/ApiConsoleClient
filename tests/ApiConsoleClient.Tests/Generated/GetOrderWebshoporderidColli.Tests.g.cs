...
public sealed class GetOrderWebshoporderidColliTests
{
    [Fact]
    public async Task GetOrderWebshoporderidColli_HappyPath()
    {
        ...
        var req = new GetOrderWebshoporderidColliRequest { Webshoporderid = "x" };
        var result = await client.GetOrderWebshoporderidColliAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/order/x/colli").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetOrderWebshoporderidColli_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetOrderWebshoporderidColliRequest { Webshoporderid = "x" };
        var act = async () => await client.GetOrderWebshoporderidColliAsync(req, System.Threading.CancellationToken.None);
