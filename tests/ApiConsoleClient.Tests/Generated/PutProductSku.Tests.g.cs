...
public sealed class PutProductSkuTests
{
    [Fact]
    public async Task PutProductSku_HappyPath()
    {
        ...
        var req = new PutProductSkuRequest { Sku = "x", Body = default! };
        var result = await client.PutProductSkuAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/product/x").WithVerb(System.Net.Http.HttpMethod.Put);
    }
    [Fact]
    public async Task PutProductSku_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PutProductSkuRequest { Sku = "x", Body = default! };
        var act = async () => await client.PutProductSkuAsync(req, System.Threading.CancellationToken.None);
