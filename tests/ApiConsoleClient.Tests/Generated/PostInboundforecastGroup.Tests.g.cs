...
public sealed class PostInboundforecastGroupTests
{
    [Fact]
    public async Task PostInboundforecastGroup_HappyPath()
    {
        ...
        var req = new PostInboundforecastGroupRequest { Body = default! };
        var result = await client.PostInboundforecastGroupAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/inboundforecast/group").WithVerb(System.Net.Http.HttpMethod.Post);
    }
    [Fact]
    public async Task PostInboundforecastGroup_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PostInboundforecastGroupRequest { Body = default! };
        var act = async () => await client.PostInboundforecastGroupAsync(req, System.Threading.CancellationToken.None);
