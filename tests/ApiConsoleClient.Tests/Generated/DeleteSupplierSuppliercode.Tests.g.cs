...
public sealed class DeleteSupplierSuppliercodeTests
{
    [Fact]
    public async Task DeleteSupplierSuppliercode_HappyPath()
    {
        ...
        var req = new DeleteSupplierSuppliercodeRequest { Suppliercode = "x" };
        await client.DeleteSupplierSuppliercodeAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/supplier/x").WithVerb(System.Net.Http.HttpMethod.Delete);
    }
    [Fact]
    public async Task DeleteSupplierSuppliercode_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new DeleteSupplierSuppliercodeRequest { Suppliercode = "x" };
        var act = async () => await client.DeleteSupplierSuppliercodeAsync(req, System.Threading.CancellationToken.None);
