...
public sealed class GetInboundforecastGroupReferenceTests
{
    [Fact]
    public async Task GetInboundforecastGroupReference_HappyPath()
    {
        ...
        var req = new GetInboundforecastGroupReferenceRequest { Reference = "x" };
        var result = await client.GetInboundforecastGroupReferenceAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/inboundforecast/group/x").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetInboundforecastGroupReference_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetInboundforecastGroupReferenceRequest { Reference = "x" };
        var act = async () => await client.GetInboundforecastGroupReferenceAsync(req, System.Threading.CancellationToken.None);
