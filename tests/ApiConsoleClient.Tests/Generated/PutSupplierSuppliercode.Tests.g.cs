...
public sealed class PutSupplierSuppliercodeTests
{
    [Fact]
    public async Task PutSupplierSuppliercode_HappyPath()
    {
        ...
        var req = new PutSupplierSuppliercodeRequest { Suppliercode = "x", Body = default! };
        var result = await client.PutSupplierSuppliercodeAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/supplier/x").WithVerb(System.Net.Http.HttpMethod.Put);
    }
    [Fact]
    public async Task PutSupplierSuppliercode_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PutSupplierSuppliercodeRequest { Suppliercode = "x", Body = default! };
        var act = async () => await client.PutSupplierSuppliercodeAsync(req, System.Threading.CancellationToken.None);
