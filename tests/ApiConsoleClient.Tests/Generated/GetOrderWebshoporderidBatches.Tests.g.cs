...
public sealed class GetOrderWebshoporderidBatchesTests
{
    [Fact]
    public async Task GetOrderWebshoporderidBatches_HappyPath()
    {
        ...
        var req = new GetOrderWebshoporderidBatchesRequest { Webshoporderid = "x" };
        var result = await client.GetOrderWebshoporderidBatchesAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/order/x/batches").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetOrderWebshoporderidBatches_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetOrderWebshoporderidBatchesRequest { Webshoporderid = "x" };
        var act = async () => await client.GetOrderWebshoporderidBatchesAsync(req, System.Threading.CancellationToken.None);
