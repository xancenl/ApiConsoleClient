...
public sealed class GetProductSkuTests
{
    [Fact]
    public async Task GetProductSku_HappyPath()
    {
        ...
        var req = new GetProductSkuRequest { Sku = "x" };
        var result = await client.GetProductSkuAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/product/x").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetProductSku_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetProductSkuRequest { Sku = "x" };
        var act = async () => await client.GetProductSkuAsync(req, System.Threading.CancellationToken.None);
