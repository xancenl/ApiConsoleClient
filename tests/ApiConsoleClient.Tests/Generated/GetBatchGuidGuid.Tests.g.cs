...
public sealed class GetBatchGuidGuidTests
{
    [Fact]
    public async Task GetBatchGuidGuid_HappyPath()
    {
        ...
        var req = new GetBatchGuidGuidRequest { Guid = "x" };
        var result = await client.GetBatchGuidGuidAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/Batch/guid/x").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetBatchGuidGuid_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetBatchGuidGuidRequest { Guid = "x" };
        var act = async () => await client.GetBatchGuidGuidAsync(req, System.Threading.CancellationToken.None);
