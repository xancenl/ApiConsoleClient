...
public sealed class GetInboundforecastGroupGuidTests
{
    [Fact]
    public async Task GetInboundforecastGroupGuid_HappyPath()
    {
        ...
        var req = new GetInboundforecastGroupGuidRequest { Guid = "x" };
        var result = await client.GetInboundforecastGroupGuidAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/inboundforecast/group/x").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetInboundforecastGroupGuid_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetInboundforecastGroupGuidRequest { Guid = "x" };
        var act = async () => await client.GetInboundforecastGroupGuidAsync(req, System.Threading.CancellationToken.None);
