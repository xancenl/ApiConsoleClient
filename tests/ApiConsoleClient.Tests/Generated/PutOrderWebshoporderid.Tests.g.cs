...
public sealed class PutOrderWebshoporderidTests
{
    [Fact]
    public async Task PutOrderWebshoporderid_HappyPath()
    {
        ...
        var req = new PutOrderWebshoporderidRequest { Webshoporderid = "x", Body = default! };
        var result = await client.PutOrderWebshoporderidAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/order/x").WithVerb(System.Net.Http.HttpMethod.Put);
    }
    [Fact]
    public async Task PutOrderWebshoporderid_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PutOrderWebshoporderidRequest { Webshoporderid = "x", Body = default! };
        var act = async () => await client.PutOrderWebshoporderidAsync(req, System.Threading.CancellationToken.None);
