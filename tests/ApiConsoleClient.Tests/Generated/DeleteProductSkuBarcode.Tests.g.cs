...
public sealed class DeleteProductSkuBarcodeTests
{
    [Fact]
    public async Task DeleteProductSkuBarcode_HappyPath()
    {
        ...
        var req = new DeleteProductSkuBarcodeRequest { Sku = "x" };
        await client.DeleteProductSkuBarcodeAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/product/x/barcode").WithVerb(System.Net.Http.HttpMethod.Delete);
    }
    [Fact]
    public async Task DeleteProductSkuBarcode_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new DeleteProductSkuBarcodeRequest { Sku = "x" };
        var act = async () => await client.DeleteProductSkuBarcodeAsync(req, System.Threading.CancellationToken.None);
