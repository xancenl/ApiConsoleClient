...
public sealed class GetOrderWebshoporderidTests
{
    [Fact]
    public async Task GetOrderWebshoporderid_HappyPath()
    {
        ...
        var req = new GetOrderWebshoporderidRequest { Webshoporderid = "x", Channel = "x" };
        var result = await client.GetOrderWebshoporderidAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/order/x?channel=x").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetOrderWebshoporderid_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetOrderWebshoporderidRequest { Webshoporderid = "x", Channel = "x" };
        var act = async () => await client.GetOrderWebshoporderidAsync(req, System.Threading.CancellationToken.None);
