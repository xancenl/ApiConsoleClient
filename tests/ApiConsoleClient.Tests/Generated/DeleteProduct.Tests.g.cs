...
{
    [Fact]
    public async Task DeleteProduct_HappyPath()
    {
        ...
        var req = new DeleteProductRequest { Sku = "x" };
        await client.DeleteProductAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/product").WithVerb(System.Net.Http.HttpMethod.Delete);
    }
    [Fact]
    public async Task DeleteProduct_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new DeleteProductRequest { Sku = "x" };
        var act = async () => await client.DeleteProductAsync(req, System.Threading.CancellationToken.None);
