...
public sealed class PostShippingoptionsTests
{
    [Fact]
    public async Task PostShippingoptions_HappyPath()
    {
        ...
        var req = new PostShippingoptionsRequest { Body = default! };
        var result = await client.PostShippingoptionsAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/shippingoptions").WithVerb(System.Net.Http.HttpMethod.Post);
    }
    [Fact]
    public async Task PostShippingoptions_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PostShippingoptionsRequest { Body = default! };
        var act = async () => await client.PostShippingoptionsAsync(req, System.Threading.CancellationToken.None);
