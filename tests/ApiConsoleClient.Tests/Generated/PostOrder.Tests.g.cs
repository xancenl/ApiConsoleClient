...
public sealed class PostOrderTests
{
    [Fact]
    public async Task PostOrder_HappyPath()
    {
        ...
        var req = new PostOrderRequest { Body = default! };
        var result = await client.PostOrderAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/order").WithVerb(System.Net.Http.HttpMethod.Post);
    }
    [Fact]
    public async Task PostOrder_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PostOrderRequest { Body = default! };
        var act = async () => await client.PostOrderAsync(req, System.Threading.CancellationToken.None);
