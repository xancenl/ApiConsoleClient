...
public sealed class PutProductTests
{
    [Fact]
    public async Task PutProduct_HappyPath()
    {
        ...
        var req = new PutProductRequest { Sku = "x", Body = default! };
        var result = await client.PutProductAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/product").WithVerb(System.Net.Http.HttpMethod.Put);
    }
    [Fact]
    public async Task PutProduct_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PutProductRequest { Sku = "x", Body = default! };
        var act = async () => await client.PutProductAsync(req, System.Threading.CancellationToken.None);
