...
public sealed class GetReturnIdTests
{
    [Fact]
    public async Task GetReturnId_HappyPath()
    {
        ...
        var req = new GetReturnIdRequest { Id = 1 };
        var result = await client.GetReturnIdAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/return/1").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetReturnId_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetReturnIdRequest { Id = 1 };
        var act = async () => await client.GetReturnIdAsync(req, System.Threading.CancellationToken.None);
