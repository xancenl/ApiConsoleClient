...
public sealed class GetSupplierSuppliercodeTests
{
    [Fact]
    public async Task GetSupplierSuppliercode_HappyPath()
    {
        ...
        var req = new GetSupplierSuppliercodeRequest { Suppliercode = "x" };
        var result = await client.GetSupplierSuppliercodeAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/supplier/x").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetSupplierSuppliercode_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetSupplierSuppliercodeRequest { Suppliercode = "x" };
        var act = async () => await client.GetSupplierSuppliercodeAsync(req, System.Threading.CancellationToken.None);
