...
public sealed class GetReturnreasonsTests
{
    [Fact]
    public async Task GetReturnreasons_HappyPath()
    {
        using var http = new HttpTest();
        http.RespondWithJson(System.Array.Empty<MontaRESTApiModels_ReturnForecast_ReturnReason>());
        ...
        var req = new GetReturnreasonsRequest {  };
        var result = await client.GetReturnreasonsAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/returnreasons").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetReturnreasons_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetReturnreasonsRequest {  };
        var act = async () => await client.GetReturnreasonsAsync(req, System.Threading.CancellationToken.None);
