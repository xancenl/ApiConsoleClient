...
public sealed class GetInfoTests
{
    [Fact]
    public async Task GetInfo_HappyPath()
    {
        ...
        var req = new GetInfoRequest { Origin = "x" };
        var result = await client.GetInfoAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/info?origin=x").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetInfo_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetInfoRequest { Origin = "x" };
        var act = async () => await client.GetInfoAsync(req, System.Threading.CancellationToken.None);
