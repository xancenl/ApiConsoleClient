...
public sealed class GetReturnlabelsTtcodeTests
{
    [Fact]
    public async Task GetReturnlabelsTtcode_HappyPath()
    {
        ...
        var req = new GetReturnlabelsTtcodeRequest { Ttcode = "x" };
        var result = await client.GetReturnlabelsTtcodeAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/returnlabels/x").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetReturnlabelsTtcode_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetReturnlabelsTtcodeRequest { Ttcode = "x" };
        var act = async () => await client.GetReturnlabelsTtcodeAsync(req, System.Threading.CancellationToken.None);
