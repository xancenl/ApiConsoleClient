...
public sealed class GetReturnforecastCodeTests
{
    [Fact]
    public async Task GetReturnforecastCode_HappyPath()
    {
        ...
        var req = new GetReturnforecastCodeRequest { Code = "x" };
        var result = await client.GetReturnforecastCodeAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/returnforecast/x").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetReturnforecastCode_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetReturnforecastCodeRequest { Code = "x" };
        var act = async () => await client.GetReturnforecastCodeAsync(req, System.Threading.CancellationToken.None);
