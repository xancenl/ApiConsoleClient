...
public sealed class GetReportsIdFileTests
{
    [Fact]
    public async Task GetReportsIdFile_HappyPath()
    {
        using var http = new HttpTest();
        http.RespondWithJson(System.Array.Empty<byte>());
        ...
        var req = new GetReportsIdFileRequest { Id = "x" };
        var result = await client.GetReportsIdFileAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/reports/x/file").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetReportsIdFile_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetReportsIdFileRequest { Id = "x" };
        var act = async () => await client.GetReportsIdFileAsync(req, System.Threading.CancellationToken.None);
