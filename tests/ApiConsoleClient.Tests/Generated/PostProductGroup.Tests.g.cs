...
public sealed class PostProductGroupTests
{
    [Fact]
    public async Task PostProductGroup_HappyPath()
    {
        ...
        var req = new PostProductGroupRequest { Body = default! };
        var result = await client.PostProductGroupAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/ProductGroup").WithVerb(System.Net.Http.HttpMethod.Post);
    }
    [Fact]
    public async Task PostProductGroup_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PostProductGroupRequest { Body = default! };
        var act = async () => await client.PostProductGroupAsync(req, System.Threading.CancellationToken.None);
