...
public sealed class PutInboundforecastGroupReferenceTests
{
    [Fact]
    public async Task PutInboundforecastGroupReference_HappyPath()
    {
        ...
        var req = new PutInboundforecastGroupReferenceRequest { Reference = "x", Body = default! };
        var result = await client.PutInboundforecastGroupReferenceAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/inboundforecast/group/x").WithVerb(System.Net.Http.HttpMethod.Put);
    }
    [Fact]
    public async Task PutInboundforecastGroupReference_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new PutInboundforecastGroupReferenceRequest { Reference = "x", Body = default! };
        var act = async () => await client.PutInboundforecastGroupReferenceAsync(req, System.Threading.CancellationToken.None);
