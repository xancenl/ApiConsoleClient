...
public sealed class GetProductGroupProductGroupIdTests
{
    [Fact]
    public async Task GetProductGroupProductGroupId_HappyPath()
    {
        ...
        var req = new GetProductGroupProductGroupIdRequest { ProductGroupId = 1 };
        var result = await client.GetProductGroupProductGroupIdAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/ProductGroup/1").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetProductGroupProductGroupId_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetProductGroupProductGroupIdRequest { ProductGroupId = 1 };
        var act = async () => await client.GetProductGroupProductGroupIdAsync(req, System.Threading.CancellationToken.None);
