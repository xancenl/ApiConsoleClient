...
public sealed class GetOrderWebshoporderidReturnTests
{
    [Fact]
    public async Task GetOrderWebshoporderidReturn_HappyPath()
    {
        ...
        var req = new GetOrderWebshoporderidReturnRequest { Webshoporderid = "x" };
        var result = await client.GetOrderWebshoporderidReturnAsync(req, System.Threading.CancellationToken.None);
        http.ShouldHaveCalled("https://api.test/order/x/return").WithVerb(System.Net.Http.HttpMethod.Get);
    }
    [Fact]
    public async Task GetOrderWebshoporderidReturn_ErrorPath()
    {
        using var http = new HttpTest();
        ...
        var client = new ApiConsoleClient.ApiClient.ApiClient(new NullLogger<ApiConsoleClient.ApiClient.ApiClient>(), new ApiConsoleClient.ApiClient.ApiClientOptions { BaseUrl = new Uri("https://api.test") }, new ApiConsoleClient.Tests.NoAuth());
        var req = new GetOrderWebshoporderidReturnRequest { Webshoporderid = "x" };
        var act = async () => await client.GetOrderWebshoporderidReturnAsync(req, System.Threading.CancellationToken.None);
